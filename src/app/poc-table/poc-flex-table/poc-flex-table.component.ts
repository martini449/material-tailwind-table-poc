...
import {TableShoppingCartElement} from "../poc-table/poc-table.component";
...
@Component({
  selector: 'app-poc-flex-table',
  templateUrl: './poc-flex-table.component.html',
  styleUrls: ['./poc-flex-table.component.scss']
})
export class PocFlexTableComponent {
